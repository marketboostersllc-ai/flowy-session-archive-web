    ...
    <main className="mx-auto w-full max-w-5xl flex-1 px-6 py-16">
      <header className="mb-10">
        ...
        <p className="mt-3 max-w-2xl text-sm leading-relaxed text-text-dim">
          ...
          profit de la estrategia. Salida por tiempo a los {DEFAULT_PARAMS.maxHoldSec / 60} min si no toca
          ninguno. Migración = dirección &quot;imán&quot; (hacia el goal que gana volumen). Doble confirmación =
